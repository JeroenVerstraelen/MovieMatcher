...
namespace MovieMatcher.View
{
    ...
    public partial class TinderPage : ContentPage
    {
        ...
        public TinderPage()
        {
            ...
            TinderPageViewModel ViewModel = new TinderPageViewModel();
        ...
        {
            //Movie topMovie = (Movie)SwipeCardView.TopItem;
            //await Navigation.PushAsync(new VideoPopUp(topMovie));
        }
        private async void OnFriendsClicked(object sender, EventArgs e)
        {
            // DisplayAlert("Test", "Message", "Cancel");
